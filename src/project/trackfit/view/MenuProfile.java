...
public class MenuProfile extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		if (v.equals(home)) startActivity(new Intent(getApplicationContext(), MenuHome.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
		else if (v.equals(tracker)) startActivity(new Intent(getApplicationContext(), MenuSportTrack.class));
		else if (v.equals(history)) startActivity(new Intent(getApplicationContext(), MenuActHistory.class));
